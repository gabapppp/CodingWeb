...
from compiler.service import get_command, get_extension, get_target_method
...
def run_code(code, language, version):
    ...
    process = multiprocessing.Process(target=target_method, args=(client, file_name, container_name, command_string, return_dict))
    process.start()
